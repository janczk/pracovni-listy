          ...
          parts: [
            {
              text: [
                ...
                `- true_false: tvrzení s dvěma možnostmi a správnou odpovědí. Možnosti i odpověď piš VŽDY v jazyce ${lang} (např. v češtině \"Pravda\"/\"Nepravda\" nebo \"Ano\"/\"Ne\", nikdy nepoužívej anglické true/false).`,
