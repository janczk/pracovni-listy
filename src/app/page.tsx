      ...
      <div className="max-w-2xl mx-auto w-full px-4 py-12 sm:py-16">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2">
          <Link
            ...
            className="group flex flex-col rounded-2xl border border-slate-200/80 bg-white p-6 shadow-card transition-all hover:border-primary-200 hover:shadow-card-hover"
          >
            <span className="text-lg font-semibold text-slate-900 group-hover:text-primary-700">
